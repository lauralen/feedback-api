...
const RequestSchema = new mongoose.Schema({
    title: { 
        type: String, 
        maxLength: [MAX_TITLE_LENGTH, `Title cannot be more than ${MAX_TITLE_LENGTH} characters`],
        unique: true,
        trim: true,
    ...
    description: { 
        ...
        trim: true,
        maxLength: [MAX_DESCRIPTION_LENGTH, `Description cannot be more than ${MAX_DESCRIPTION_LENGTH} characters`],
    },
    createdAt: {
        type: Date,
        default: Date.now
